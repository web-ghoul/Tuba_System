...
const CounterCardsSection = () => {
  return (
    <Box className={`grid justify-stretch items-center gap-4 grid-cols-4`}>
      <CounterCard
        icon={
          <BalanceRounded className={`!text-counter_card_purple text-[20px]`} />
        }
        number={"1200"}
        unit={"ر . س"}
      ...
      <CounterCard
        icon={
          <BalanceRounded className={`text-counter_card_red text-[20px]`} />
        }
        number={"1200"}
        unit={"ر . س"}
      ...
      <CounterCard
        icon={
          <ReceiptLongOutlined
            className={`text-counter_card_cyan text-[20px]`}
          />
        }
        number={"1800"}
        unit={"مطالبة"}
        ...
        back={"/images/balance_bg.svg"}
        back_icon_color={"bg-counter_card_cyan_light"}
      />
      <CounterCard
        icon={
          <PiUsersThreeLight
            className={`text-counter_card_purple text-[20px]`}
          />
        }
        number={"100"}
        unit={"موظف"}
      ...
      <CounterCard
        icon={
          <PiUsersThreeLight
            className={`!text-counter_card_green text-[20px]`}
          />
        }
        number={"100"}
        unit={"موظف"}
      ...
      <CounterCard
        icon={
          <PiUsersThreeLight className={`text-counter_card_red text-[20px]`} />
        }
        number={"100"}
        unit={"موظف"}
      ...
      <CounterCard
        icon={
          <Diversity1Outlined className={`text-counter_card_red text-[20px]`} />
        }
        number={"100"}
        unit={"تابع"}
